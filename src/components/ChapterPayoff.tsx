  ...
  return (
    <div className="leave leave-memo">
      <header className="leave-memo-top">
        ...
        <p className="leave-stamp">Review draft</p>
      </header>
      <p className="leave-memo-body">{artifact.page.body}</p>
      ...
      <ul className="leave-stamps">
        ...
        {artifact.targets.map((person) => (
          <li key={person.name}>
            <strong>
              {person.name}. {person.role}
            </strong>
            <span>{person.why}</span>
          </li>
        ))}
      </ul>
    </div>
  ...
  return (
    <div className="leave leave-pack">
      <header className="leave-pack-top">
        <p className="leave-kicker">Field pack</p>
        <h3>{artifact.title}</h3>
      </header>
  ...
  return (
    <div className="leave leave-answer">
      <header className="leave-answer-top">
        <div>
          <p className="leave-kicker">Review note</p>
